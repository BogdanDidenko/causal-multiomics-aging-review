...
named the **Causal Multi-omics Aging Content Model (CMACM) v1.0.1**.

Version 1.0.1 is a transport-only amendment to v1.0.0. It converts the dynamic
...
entity, relation, axis, or boundary rule.
